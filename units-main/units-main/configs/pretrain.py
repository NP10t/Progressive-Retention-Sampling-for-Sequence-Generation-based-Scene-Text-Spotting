# sudo -H PYTHONPATH=$PWD python script/train.py --conf configs/pretrain.py
...
train_transform = [
    ...
    L[RandomResizeScale](0.3, 2.0, (train_size, train_size)),
    L[RandomCrop]((train_size, train_size)),
